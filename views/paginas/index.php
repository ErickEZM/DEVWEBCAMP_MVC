...
<section class="resumen">
    <div class="resumen__grid">
        <div <?php aos_animacion();?> class="resumen__bloque" data-aos-offset="0">
...
<section class="speakers__mobile">
    <h2 class="speakers__heading">Speakers</h2>
    <p class="speakers__descripcion">Conoce a nuestros expertos de DevWebCamp</p>
    <div class="speakers__grid">
    <?php foreach($ponentes as $ponente) { ?>
        <div <?php aos_animacion(); ?> class="speaker" data-aos-offset=<?php echo ($ponente->id === '18' || $ponente->id === '17' || $ponente->id === '16' ) ? 0 : '' ?>>
            <picture>
...
<section class="boletos">
    ...
    <div class="boletos__grid">
        <div  class="boleto boleto--presencial" <?php aos_animacion(); ?> data-aos-offset="-700">
            <h4 class="boleto__logo">&#60;DevWebCamp/></h4>
            <p class="boleto__plan">Presencial</p>
            <p class="boleto__precio">$199</p>
        </div>
        <div  class="boleto boleto--virtual" <?php aos_animacion(); ?> data-aos-offset="-700">
            <h4 class="boleto__logo">&#60;DevWebCamp/></h4>
            <p class="boleto__plan">Virtual</p>
            <p class="boleto__precio">$49</p>
        </div>
        <div  class="boleto boleto--gratis" <?php aos_animacion(); ?> data-aos-offset="-700">
            <h4 class="boleto__logo">&#60;DevWebCamp/></h4>
    ...
    <div class="boleto__enlace-contenedor">
        <a href="/paquetes" class="boleto__enlace">Ver Paqutes</a>
    </div>
</section>