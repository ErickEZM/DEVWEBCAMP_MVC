<aside class="dashboard__sidebar">
    <nav class="dashboard__menu">
        ...
        <?php echo pagina_actual('/ponentes') ? 'dashboard__enlace--actual' : ''  ?>">
        ...
        <?php echo pagina_actual('/eventos') ? 'dashboard__enlace--actual' : ''  ?>">
        ...
        <?php echo pagina_actual('/regalos') ? 'dashboard__enlace--actual' : ''  ?>">
